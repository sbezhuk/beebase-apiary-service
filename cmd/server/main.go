// Command server is the entry point for the BeeBase apiary-service.
package main
...
import (
	...
	"github.com/sbezhuk/beebase-apiary-service/internal/config"
	...
	"github.com/sbezhuk/beebase-apiary-service/internal/platform/notificationclient"
...
func run() error {
	...
	apiaryService := appapiary.NewService(apiaryRepo, hiveDeleter, mediaDeleter, subscriptionClient, notifications)
	apiaryHandler := apiaryhttp.NewHandler(apiaryService, log, cfg.PublicBaseURL, notifications)
